...
public class ExceptionMapper extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ExceptionHandler(com.content.exception.ExpiredJwtException.class)
    protected ResponseEntity<Object> handleExpiredJwtException(com.content.exception.ExpiredJwtException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ErrorMessage response = new ErrorMessage(HttpStatus.UNAUTHORIZED.value(), "Authentification exception", ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.UNAUTHORIZED);
    }
    ...
    protected ResponseEntity<Object> handleAccessDeniedException(AccessDeniedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ErrorMessage response = new ErrorMessage(HttpStatus.FORBIDDEN.value(), "You do not have the required role to access this resource.", ex.getMessage());
        return new ResponseEntity<>(response, HttpStatus.FORBIDDEN);
    }
